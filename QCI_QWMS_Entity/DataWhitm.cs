...
namespace QWMS.Entity
{
    ...
    //  <summary>
    // DataWhitm 針對 WHITM Table提供Insert,Update,Delete,Query的功能
    //  <summary>
    public class DataWhitm : EntityBase
    {

        #region Constructor
        #region 不傳入任何參數產生DataWhitm物件 by Rock Tzeng
        /// <summary>
        /// 不傳入任何參數產生DataWhitm物件。
        /// </summary>
        /// <example>
        /// <code>
        ...
        /// </example>
        /////////////////////////////////////////////////////////////////////////////
        public DataWhitm(UserInfo varUserData)
        ...
        #region 利用傳入參數產生DataWhitm物件 by Rock Tzeng
        /// <summary>
        /// 利用傳入參數產生DataWhitm物件。
        /// </summary>
        ...
        /// </code>
        /// </example>
        public DataWhitm(int varDBType, string varDBCode, int varErrorType, string varErrorCode, UserInfo varUserData)
        {
            ...
            ControlErrorInfo.ObjectName = "QWMS.Entity.DataWhitm";
            ...
            this.EntityTableName = "DBO.WHITM";
