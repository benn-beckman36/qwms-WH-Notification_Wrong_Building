...
{
    public class DataAlgin : EntityBase
    {
        #region Constructor
        #region
        public DataAlgin(UserInfo varUserData)
        ...
        #region 构造
        public DataAlgin(int varDBType, string varDBCode, int varErrorType, string varErrorCode, UserInfo varUserData)
        {
            ...
            ControlErrorInfo.ObjectName = "QWMS.Entity.DataAlgin";
            ...
            this.EntityTableName = "DBO.ALGIN";
        ...
        public string Message
        {
            get
            {
                if (htFields["MESSAGE"] == null)
                {
                    return null;
                }
                return htFields["MESSAGE"].ToString();
            }
            set
            {
                htFields["MESSAGE"] = value;
            }
        }
        #endregion
        ...
        protected override void SettingFields()
        {
            ...
            htFieldType.Add("MESSAGE", DBDataType.DBString);
