...
namespace QWMS.Entity
{
    ...
    //  <summary>
    public class DataWhlog_PAL : EntityBase
    {
        ...
        /// </example>
        /////////////////////////////////////////////////////////////////////////////
        public DataWhlog_PAL(UserInfo varUserData)
        ...
        /// </code>
        /// </example>
        public DataWhlog_PAL(int varDBType, string varDBCode, int varErrorType, string varErrorCode, UserInfo varUserData)
        {
        ...
        // Logid
        //  <summary>
        public string ZPALLETID
        {
            get
            {
                if (htFields["ZPALLETID"] == null)
                {
                    return null;
                }
                return htFields["ZPALLETID"].ToString();
            }
            set
            {
                htFields["ZPALLETID"] = value;
            }
        }
        #endregion
