...
namespace QWMS
{
    public partial class Transfer_LocationSelectBymblnr : Form
    {
       ...
       private System.Windows.Forms.Button btnSelect;
        ...
        public Transfer_LocationSelectBymblnr(UserInfo varUserData, string strProgid, string strWerks, string strLgort,string strmblnr)
        {
        ...
        private void ShowLocationData()
        {
            try
            {
                ...
                dtData = objPlantData.GetAllLocatDataBymblnr(strWerks, strLgort,strMblnr);
