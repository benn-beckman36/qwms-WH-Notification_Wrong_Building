...
namespace QWMS
{
    public partial class TransferOutGuardConfirm : Form
    {
        #region 变量
        ...
        #endregion
        public TransferOutGuardConfirm(UserInfo varUserData, string strProgid)
        {
            InitializeComponent();
        ...
        public void Query()
        {
            ...
            {
                QCI.QWMS.Transfer objTransfer = new Transfer(UserData, strWerks, strLgort);
                dtData = objTransfer.GetTransferData(lblLicenseNo.Text,lblPCID.Text,strGRNO,"E");
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            if (strStatus == "WL")
            {
                MessageBox.Show("确认信息无误，准许离厂");
                objTransfer.UpdateStatus(lblGRNOOut.Text, Usrnm,strStatus);
                MessageBox.Show("离厂成功");
            }
           
            else
            {
                MessageBox.Show("目前状态是" + dtStatus.Rows[0]["ST"].ToString() + "，不可离厂，请确认！");
            }
