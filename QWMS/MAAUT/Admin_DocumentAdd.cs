...
namespace QWMS
{
    public partial class Admin_DocumentAdd : Form
    {
        public Admin_DocumentAdd()
        {
            InitializeComponent();
        }
        ...
        public Admin_DocumentAdd(UserInfo varUserData, string strProgid)
        {
            InitializeComponent();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                for (int i = 0; i < dtData.Rows.Count; i++)
                {
                    ...
                    if (Convert.ToInt16(dtData.Rows[i]["MdQty"].ToString()) > 0)
                    {
